...
export class StyleGenerator {
    private config: IWeChatMarkdownConfig;
    ...
    private getThemeColor(theme: string, defaultColor: string): string {
        switch (theme) {
    ...
    private getCodeBlockStyles(style: string, theme: string): string {
        ...
        // Apply Highlight.js Theme Colors
        // We now load the full CSS file in the node, so we only need to ensure basic overrides if necessary.
        // For now, we rely on the loaded CSS.
        css += `
            p code, li code { 
    ...
    private isLightTheme(theme: string): boolean {
        return theme === 'github' || theme === 'github-light';
    }

    private getCodeThemeBackground(theme: string): string {
        switch (theme) {
